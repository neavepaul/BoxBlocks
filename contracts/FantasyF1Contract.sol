...
contract FantasyF1Contract is ERC721Enumerable, Ownable(msg.sender) {
    ...
    function initialize() external onlyOwner {
        ...
        driverNames[6] = "Kevin";
        driverNames[7] = "Daniel";
        driverNames[8] = "Charles";
        driverNames[9] = "Alex";
        driverNames[10] = "George";
        driverNames[11] = "Yuki";
        driverNames[12] = "Fernando";
        driverNames[13] = "Lance";
        driverNames[14] = "Gasly";
        driverNames[15] = "Esteban";
        driverNames[16] = "Niko";
        driverNames[17] = "Logan";
        driverNames[18] = "Zhou";
        driverNames[19] = "Bottas";
    ...
    function startRace() external onlyOwner {
        ...
        for (uint256 i = 0; i < totalTeams; i++) {
            ...
            raceScores[nextRaceId][teamId] = score;
        }
    ...
    function getLeaderboard() external view returns (string[3] memory teamNames, uint256[3] memory scores) {
        ...
        for (uint256 i = 0; i < totalTeams; i++) {
            uint256 score = raceScores[nextRaceId - 1][i];
